...
| 系统结构 | `03-总体架构与接口约定.md`、`11-公共工程骨架与运行.md`、`12-成员并行开发开工指南.md` | 三模块 POM、六模块扩展位置、架构 ADR | PR #7 已合并；并行开发基线待合并 |
| 公共 Message | `03-总体架构与接口约定.md` 3 | Request/Response、ActionRouter、`COMMON.PING`、单元/集成测试 | 路由和最小契约已实现，业务契约由各模块设计 |
...
| 测试 | `06-验收与提交清单.md` | 测试计划、用例、结果、缺陷修复链接 | 公共层 7 个自动测试通过，业务测试待开发 |
