...
| 系统结构 | `03-总体架构与接口约定.md`、`11-公共工程骨架与运行.md` | 三模块 POM、包结构、架构 ADR | 骨架已验证，待 PR 合并 |
| 公共 Message | `03-总体架构与接口约定.md` 3 | Request/Response、`COMMON.PING`、集成测试 | 最小契约已实现，业务契约待设计 |
...
| ADR-0003 C/S 三模块架构 | 通过，最小实现已验证 | 三模块 POM、Socket PING/PONG、2 个集成测试 | PR 合并、业务扩展和完整并发验证 |
