...
public final class FinalDemoRoster {
    ...
    private static final List<AccountSeed> ACCOUNTS = List.of(
            account("U-ADMIN-001", "20260000", "吴尚扬", Role.SUPER_ADMIN,
                    Set.of(AdminScope.STUDENT, AdminScope.COURSE, AdminScope.LIBRARY,
                            AdminScope.SHOP, AdminScope.HOSPITAL)),
            account("U-STUDENT-ADMIN-001", "20260001", "施天琦", Role.USER,
                    Set.of(AdminScope.STUDENT)),
            account("U-COURSE-ADMIN-001", "20260002", "杨凯涵", Role.USER,
                    Set.of(AdminScope.COURSE)),
            account("U-LIBRARY-ADMIN-001", "20260003", "吴昊哲", Role.USER,
                    Set.of(AdminScope.LIBRARY)),
            account("U-SHOP-ADMIN-001", "20260004", "葛丰玮", Role.USER,
                    Set.of(AdminScope.SHOP)),
            account("U-HOSPITAL-ADMIN-001", "20260005", "廖俊杰", Role.USER,
                    Set.of(AdminScope.HOSPITAL)),
            account("U-STUDENT-001", "20260006", "周一", Role.USER, Set.of()),
            account("U-STUDENT-002", "20260007", "周二", Role.USER, Set.of()),
            account("U-STUDENT-003", "20260008", "周三", Role.USER, Set.of()),
            account("U-STUDENT-004", "20260009", "周四", Role.USER, Set.of()),
            account("U-STUDENT-005", "20260010", "周五", Role.USER, Set.of()),
            account("U-STUDENT-006", "20260011", "周六", Role.USER, Set.of()),
            account("U-STUDENT-007", "20260012", "周七", Role.USER, Set.of()),
            account("U-STUDENT-008", "20260013", "周八", Role.USER, Set.of()),
            account("U-STUDENT-009", "20260014", "周九", Role.USER, Set.of()),
            account("U-STUDENT-010", "20260015", "周十", Role.USER, Set.of()),
            account("U-STUDENT-011", "20260016", "周十一", Role.USER, Set.of()),
            account("U-STUDENT-012", "20260017", "周十二", Role.USER, Set.of()),
            account("U-STUDENT-013", "20260018", "周十三", Role.USER, Set.of()),
            account("U-STUDENT-014", "20260019", "周十四", Role.USER, Set.of()),
            account("U-STUDENT-015", "20260020", "周十五", Role.USER, Set.of()),
